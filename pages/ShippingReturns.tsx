...
const ShippingReturns: React.FC = () => {
    return (
        <div className="bg-background min-h-screen">
            {/* Hero Section */}
            <section className="bg-vault/5 py-20 px-6">
                ...
                <div className="container mx-auto max-w-6xl">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div className="bg-white p-6 rounded-lg text-center shadow-sm">
                            <div className="w-16 h-16 bg-vault/5 rounded-full flex items-center justify-center mx-auto mb-4">
                                <Truck className="w-8 h-8 text-[#009e99]" />
                            </div>
                            <h3 className="font-sans font-medium text-primary mb-2">Free Shipping</h3>
                            <p className="text-sm text-primary/60">On orders over PKR 45,000</p>
                        </div>
                        <div className="bg-white p-6 rounded-lg text-center shadow-sm">
                            <div className="w-16 h-16 bg-vault/5 rounded-full flex items-center justify-center mx-auto mb-4">
                                <Package className="w-8 h-8 text-[#009e99]" />
                            </div>
                        ...
                        <div className="bg-white p-6 rounded-lg text-center shadow-sm">
                            <div className="w-16 h-16 bg-vault/5 rounded-full flex items-center justify-center mx-auto mb-4">
                                <RotateCcw className="w-8 h-8 text-[#009e99]" />
                            </div>
                        ...
                        <div className="bg-white p-6 rounded-lg text-center shadow-sm">
                            <div className="w-16 h-16 bg-vault/5 rounded-full flex items-center justify-center mx-auto mb-4">
                                <Shield className="w-8 h-8 text-[#009e99]" />
                            </div>
                    ...
                    <div className="space-y-12">
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <ul className="space-y-2 text-primary/70">
                                        <li>• <strong>Standard Shipping:</strong> 5-7 business days - PKR 2,500 (FREE on orders PKR 45,000+)</li>
                                        <li>• <strong>Express Shipping:</strong> 2-3 business days - PKR 6,500</li>
                                        <li>• <strong>Next Day:</strong> 1 business day - PKR 10,000</li>
                                    </ul>
                                </div>
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-2 text-primary/70">
                                        <li>• <strong>Canada:</strong> 7-10 business days - Starting at PKR 5,500</li>
                                        <li>• <strong>Europe:</strong> 10-15 business days - Starting at PKR 8,500</li>
                                        <li>• <strong>Rest of World:</strong> 12-20 business days - Starting at PKR 10,000</li>
                        ...
                        <div className="bg-white p-8 md:p-12 rounded-lg shadow-sm">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="bg-vault/5 p-6 rounded-lg mt-6">
                        ...
                        {/* Contact CTA */}
                        <div className="text-center p-8 bg-vault/5 rounded-lg">
                            ...
                            <a
                                href="/#/contact"
                                className="inline-block bg-primary text-white px-8 py-3 text-sm uppercase tracking-widest font-bold hover:bg-[#009e99] transition-colors"
                            >
                                Contact Support
                            </a>
                        </div>
