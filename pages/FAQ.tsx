...
const FAQ: React.FC = () => {
    ...
    const faqs: FAQItem[] = [
        ...
        },
        {
            ...
            answer: 'Yes! We ship worldwide. Shipping costs and delivery times vary by location. Free shipping is available for orders over PKR 45,000 within the continental US. International orders may be subject to import duties and taxes.'
        },
        {
        ...
        <div className="bg-background min-h-screen">
            ...
            <section className="py-20 px-6">
                <div className="container mx-auto max-w-3xl">
                        ...
                        {faqs.map((faq, index) => (
                            ...
                            >
                                ...
                                >
                                    ...
                                    <ChevronDown
                                        className={`w-5 h-5 text-[#009e99] flex-shrink-0 transition-transform duration-300 ${openIndex === index ? 'rotate-180' : ''
                                            }`}
                                    />
                                </button>
                                <div
                    ...
                    {/* Contact CTA */}
                    <div className="mt-16 text-center p-8 bg-vault/5 rounded-lg">
