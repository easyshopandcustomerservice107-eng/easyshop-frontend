    ...
    return (
        <div className="min-h-screen bg-white pb-20 px-6 lg:px-12">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-gray-50 rounded-[3rem] p-8 md:p-16 border border-gray-100 shadow-2xl shadow-accent-gold/5 mb-16">
                        ...
                        <div className="mt-16 space-y-12 animate-in fade-in slide-in-from-bottom-8 duration-700">
                            <div className="flex flex-wrap items-center justify-between gap-8 pb-12 border-b border-gray-100">
                                ...
                                <div>
                                    ...
                                    <p className="text-lg font-bold text-accent-gold tracking-tighter">PKR {order.totalPrice.toFixed(2)}</p>
                                </div>
                            </div>
                                ...
                                <div className="space-y-6">
                                    {order.items?.map((item: any, idx: number) => (
                                        <Link
                                            ...
                                            className="flex items-center gap-6 group/item hover:bg-accent-gold/10 p-3 -m-3 rounded-2xl transition-all"
                                        >
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <div className="flex items-center gap-4 text-[9px] font-bold uppercase tracking-[0.2em] text-gray-400">
                                                    ...
                                                    <span>•</span>
                                                    <span>Unit: PKR {item.price.toFixed(2)}</span>
                                                </div>
                                            </div>
                                            <div className="text-[11px] font-bold text-gray-900">PKR {(item.quantity * item.price).toFixed(2)}</div>
                                        </Link>
                                    ))}
                                </div>
                            </div>
